...
Hi，我是远明，是一个运维，对编程方面并不了解，目前想做一个自己的博客，此博客系统使用 [Huxpro](https://github.com/Huxpro/huxpro.github.io)的源码，目前还在修改中，部分内容还和原作者一样，若造成困扰或者不便，可联系我立即改正相应的地方。谢谢！

目前的物理活动范围主要在北京。分身日常出没于[博客](https://ifmx.cc)、[微博](https://weibo.com/ainy0293)、[Github](https://github.com/huxpro)


### 以下内容为原作者的内容，大家可以了解一下：
